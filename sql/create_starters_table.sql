CREATE TABLE vckonline.starters (
	...
	special_payout_on_turn_text mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL NULL,
	special_payout_off_turn_text mediumtext CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL NULL,
